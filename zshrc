...
############
function proj(){
    cd ~/Sites/$1 && vagrant up && vagrant ssh
}
...
plugins=(gitfast, lol, git-extras, colorize, composer, history, node-api, npm, vagrant, zsh-syntax-highlighting, screen, laravel)

source $ZSH/oh-my-zsh.sh

#PATHS
export PATH=$PATH:~/.composer/vendor/bin:/usr/bin:/bin:/usr/sbin:/sbin:/usr/local/bin:/usr/X11/bin:/usr/local/opt/ruby/bin:
...
PATH=$PATH:$NODE_PATH:$HOME/.rvm/bin # Add RVM to PATH for scripting
